            ...
            <div class="modal-body">
              <div class="row g-3">
                ...
                <div class="col-12">
                  ...
                  >
                    <i class="fas" :class="showAdvancedSettings ? 'fa-chevron-down' : 'fa-chevron-right'"></i>
                    Configuración avanzada
                  </a>
                  
                  <div class="collapse mt-2" :class="{ show: showAdvancedSettings }" id="advancedSettings">
    ...
    <div class="modal fade" id="deleteModal" tabindex="-1" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <p>¿Estás seguro de que deseas eliminar la empresa <strong>{{ companyToDelete?.first_name }}</strong>?</p>
            <p class="text-danger">
              <i class="fas fa-exclamation-triangle me-2"></i>
              Esta acción eliminará todos los usuarios asociados a esta empresa y no se puede deshacer.
            </p>
